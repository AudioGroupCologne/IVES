 ...
 *
 * In many of the js examples, you will see <a href="#/Vector">Vector</a> used to describe a
 ...
 *
 * @method copy
 * @return {Vector} A copy of the <a href="#/ Vector"> Vector</a> object
 * @example
 * <div class="norender">
 * <code>
...
/**
 * @method rem
 * @param {Vector | Number[]}  value  The divisor vector
 * @chainable
 */
...
Vector.prototype.setHeading = function setHeading(a) {
 ...
 * let v = createVector(10.0, 20.0);
 * // v has components [10.0, 20.0, 0.0]
 * let rotated_v = Vector.rotate(v, HALF_PI);
 ...
 * @param {Number}     [length] The length of the new vector (defaults to 1)
 * @return {Vector}          A new <a href="#/Vector">Vector</a> object
 * @example
 * <div modernizr='webgl'>
 * <code>
 * function setup() {
 ...
 * @method rem
 * @static
 * @param  {Vector} v1 The dividend <a href="#/Vector">Vector</a>
 * @param  {Vector} v2 The divisor <a href="#/Vector">Vector</a>
 */
/**
 * @method rem
 * @static
 ...
 * @param  {Vector} [target] The vector to receive the result
 */
Vector.rotate = function rotate(v, a, target) {
  if (arguments.length === 2) {
    target = v.copy();
  } else {
 ...
 * @param {Vector} [target] The vector to receive the result
 * @return {Vector}   The vector v, normalized to a length of 1
 */
Vector.normalize = function normalize(v, target) {
  if (arguments.length < 2) {
    target = v.copy();
  } else {
    if (!(target instanceof Vector)) {
